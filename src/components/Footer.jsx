    ...
    <footer className="bg-secondary-900 text-white mt-10 sm:mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 lg:gap-8">
          ...
          {/* Additional section for larger screens - can be used for newsletter, etc. */}
          <div className="col-span-1 hidden lg:block">
            ...
            <div className="flex">
              ...
              />
              <button className="bg-primary-600 hover:bg-primary-700 text-white px-3 py-2 text-sm rounded-r-md transition-colors">
                Subscribe
              </button>
            </div>
          </div>
